get_go_scatterplots <- function(module_list) {
  ...
  modules <- modules[!modules %in% "grey"]
    ...
    suppressWarnings(
      ...
      tryCatch({
        ...
        sim_matrix_BP %>% 
          write_rds(here(paste0("data/GO_analysis/BP/", i, "_BP_simMatrix.rds")))
        ...
        sim_matrix_MF %>% 
          write_rds(here(paste0("data/GO_analysis/MF/", i, "_MF_simMatrix.rds")))
        ...
        sim_matrix_CC %>% 
          write_rds(here(paste0("data/GO_analysis/CC/", i, "_CC_simMatrix.rds")))
    ...
    suppressWarnings(
      ...
      tryCatch({
        sim_matrix_BP <- read_rds(
          here(paste0("data/GO_analysis/BP/", i, "_BP_simMatrix.rds"))
        )
        ...
        ggsave(filename = paste0(i, "GO_scatterplot_BP.png"),
               plot = scatterGO_BP,
               device = "png",
               path = here("figures/GO_scatterplots/BP/"),
               width = 2700,
               height = 2500,
               units = "px",
               dpi = 400)
        ...
        sim_matrix_MF <- read_rds(
          here(paste0("data/GO_analysis/MF/", i, "_MF_simMatrix.rds"))
        )
        ...
        ggsave(filename = paste0(i, "GO_scatterplot_MF.png"),
               plot = scatterGO_MF,
               device = "png",
               path = here("figures/GO_scatterplots/MF/"),
               width = 2700,
               height = 2500,
               units = "px",
               dpi = 400)
        ...
        sim_matrix_CC <- read_rds(
          here(paste0("data/GO_analysis/CC/", i, "_CC_simMatrix.rds"))
        )
        ...
        ggsave(filename = paste0(i, "GO_scatterplot_CC.png"),
               plot = scatterGO_CC,
               device = "png",
               path = here("figures/GO_scatterplots/CC/"),
               width = 2700,
               height = 2500,
               units = "px",
               dpi = 400)
